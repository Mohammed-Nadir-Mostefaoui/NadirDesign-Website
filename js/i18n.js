  ...
  const LOCALES = {
    en: {
      ...
      footer: {
        ...
        form_sending:     'Opening your email app…',
        form_sent:        'Email app opened!',
    ...
    fr: {
      ...
      footer: {
        ...
        form_sending:     'Ouverture de votre messagerie…',
        form_sent:        'Messagerie ouverte !',
    ...
    ar: {
      ...
      footer: {
        ...
        form_sending:     'جارٍ فتح تطبيق البريد…',
        form_sent:        'تم فتح تطبيق البريد!',
