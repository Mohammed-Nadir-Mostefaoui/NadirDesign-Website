    ...
    fr: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_a1:   '- Conception de cinq modules ERP de bout en bout : Ventes B2B, Achats, PDV, Finance et Compatibilité — chacun gérant des données denses sur des workflows multi-rôles complexes',
    ...
    ar: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_a1:   '- تصميم خمس وحدات ERP أساسية من الألف إلى الياء: المبيعات B2B، والمشتريات، ونقاط البيع، والمالية، والتوافق — كل منها يتعامل مع كثافة بيانات عالية عبر مسارات عمل معقدة متعددة الأدوار',
