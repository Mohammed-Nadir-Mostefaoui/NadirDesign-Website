    ...
    fr: {
      ...
      work: {
        ...
        cs2: {
          ...
          stat3_num: '390', stat3_suffix: '+', stat3_label: 'écrans, 3 points de rupture',
      ...
      cs2: {
        ...
        stats: { faster: "exécution des tâches plus rapide en tests d'utilisabilité", workflows: "workflows opérationnels unifiés", screens: "écrans conçus", breakpoints: "points de rupture — mobile, tablette, desktop", components: "composants dans la bibliothèque associée", iterations: "itérations majeures du produit" },
    ...
    ar: {
      ...
      work: {
        ...
        cs2: {
          ...
          stat3_num: '390', stat3_suffix: '+', stat3_label: 'شاشة عبر 3 مقاسات',
      ...
      cs2: {
        hero: { eyebrow: "دراسة حالة 02 · تطبيق عمليات التجزئة", title: "Task Master", sub: "تطبيق لإدارة المهام لفرق متاجر التجزئة — الشراء والجرد وتصحيح المخزون وعمليات الأرفف في مسار عمل واحد واضح يُقرأ بلمحة، على الجوال والجهاز اللوحي وسطح المكتب.", role_k: "الدور", role_v: "مصمم منتج — المصمم الوحيد", client_k: "العميل", client_v: "Datamaster Analytics · ERP، فرنسا", team_k: "الفريق", team_v: "محلّل أعمال · قائد تقني · 3 فرق تطوير", platforms_k: "المنصات", platforms_v: "جوال · جهاز لوحي · سطح مكتب", cta: "لنبدأ مشروعًا مثل هذا", status: "قيد الاستخدام لدى فرق التجزئة · وحدات جديدة قيد التصميم" },
        stats: { faster: "تنفيذ أسرع للمهام في اختبارات قابلية الاستخدام", workflows: "مسارات عمل تشغيلية موحّدة", screens: "شاشة مصمّمة", breakpoints: "مقاسات عرض — جوال، لوحي، سطح مكتب", components: "مكوّنًا في المكتبة الداعمة", iterations: "إصداران رئيسيان للمنتج" },
