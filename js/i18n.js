    ...
    en: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_a5:   '- In February 2026, this partnership scaled to include the Iksir Design System project, delivered under Nawat Studio with a second designer on the team, while direct work on the ERP modules continues',
          desc_a6:   '- Task Master\'s second iteration was later rebuilt on this role',
      ...
      services: {
        ...
        s3_b2:        'RTL and LTR support built into the tokens',
        s3_b3:        'Component library with every state',
        s3_b4:        'Documentation and governance rules',
    ...
    fr: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_a5:   '- En février 2026, ce partenariat s\'est élargi au projet Iksir Design System, réalisé sous Nawat Studio avec un second designer dans l\'équipe, tandis que le travail direct sur les modules ERP se poursuit',
          desc_a6:   '- La seconde itération de Task Master a ensuite été reconstruite dans le cadre de ce rôle',
      ...
      services: {
        ...
        s3_b2:        'Support RTL et LTR intégré aux tokens',
        s3_b3:        'Bibliothèque de composants avec tous les états',
        s3_b4:        'Documentation et règles de gouvernance',
    ...
    ar: {
      ...
      work: {
        ...
        cs3: {
          ...
          approach:     'تصميم بمستوى mid-fidelity بثلاث مناطق (تنقل وجداول وإجراءات سريعة)، يُقدّم المنطق على الصقل عبر 4 مسارات مبيعات متكاملة.',
      ...
      experience: {
        ...
        dma: {
          ...
          desc_a5:   '- في فبراير 2026، توسّعت هذه الشراكة لتشمل مشروع Iksir Design System، المُنجَز عبر استوديو نواة بانضمام مصمم ثانٍ إلى الفريق، بينما يستمر العمل المباشر على وحدات ERP',
          desc_a6:   '- أُعيد لاحقًا بناء الإصدار الثاني من Task Master ضمن هذا الدور',
          role_b:    'مصمم UI/UX',
      ...
      services: {
        ...
        s3_b2:        'دعم RTL وLTR مدمج في الـtokens',
        s3_b3:        'مكتبة مكوّنات بكل الحالات',
        s3_b4:        'توثيق وقواعد حَوكمة',
