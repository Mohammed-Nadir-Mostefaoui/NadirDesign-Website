...
(function () {
    ...
    en: {
      ...
      meta: {
        home: {
          ...
          desc:  'Product designer for ERP, SaaS and internal tools: data-heavy workflows on token-first design systems. 1,033 variables, 24 components, three languages.',
        ...
        cs2: {
          ...
          og:    'How I turned spreadsheet-driven store operations into one scannable task model. 50% faster inventory task execution in usability tests.'
        },
        cs3: {
      ...
      work: {
        ...
        cs2: {
          ...
          outcome:      "50% faster inventory task execution, fewer stock-correction errors, and the visual benchmark for Datamaster's ERP suite.",
          stat1_num: '50', stat1_suffix: '%', stat1_label: 'faster inventory task execution',
        ...
        cs3: {
          ...
          outcome:      'A clear data hierarchy across the full quote-to-return flow, and the layout foundation for 3 more ERP modules.',
      ...
      experience: {
        ...
        nawat: {
          ...
          duration:  '7 mos',
          hint:      '4 highlights',
          desc_0:    '- Datamaster Analytics, my product design partner since September 2024 (below), is Nawat Studio\'s first client: in February 2026 the partnership scaled to include the Iksir Design System project.',
        ...
        dma: {
          ...
          duration:  '2 yrs',
          hint:      '2 roles · 8 bullets',
          role_a:    'Product Design Partner',
          ...
          desc_a1:   '- Worked on five core ERP modules: B2B Sales, Purchase, POS, Finance, and Accounting, each handling high data density across complex multi-role workflows',
          ...
          desc_a5:   '- In February 2026, this partnership scaled to include the Iksir Design System project, delivered under Nawat Studio with a second designer on the team, while direct work on the ERP modules continues. Task Master\'s second iteration was later rebuilt on that system',
          ...
          desc_b1:   '- Designed a mobile-first Task Management App for retail store teams: the first iteration, shipped to production'
        },
        five: {
          company:   'Five Angles',
          role:      'UI/UX Designer',
      ...
      services: {
        ...
        subtitle:     'Start with a read of what you already have, or go straight to the system underneath.',
        chip:         'Start here',
        s1_title:     'Product Audit',
        s1_promise:   'A full read of your product, written up and prioritised.',
        s1_b1:        'Heuristics, information architecture, hierarchy',
        s1_b2:        'Accessibility against WCAG 2.1 AA',
        s1_b3:        'Arabic and right-to-left readiness',
        s1_b4:        'Report, ranked issue list, roadmap, call',
        s1_meta:      'About a week',
        s1_price:     'From $1,300',
        s1_note:      'Screen-reader testing is not included. I will refer you to someone who does it.',
        s1_cta:       'Book an audit',
        s2_title:     'Product Design',
        s2_promise:   'One module, workflow, dashboard or app, designed and ready to build.',
        s2_b1:        'User flows and wireframes',
        s2_b2:        'Final screens with every state',
        s2_b3:        'A working prototype',
        s2_b4:        'Developer handoff and a session with the engineers',
        s2_meta:      'Six to ten weeks per module',
        s2_price:     'Scoped per project',
        s2_note:      'Priced per module or per flow, never as the whole product.',
        s2_cta:       "Let's scope it",
        s3_title:     'Design System',
        s3_promise:   'The foundation your products are built from.',
        s3_b1:        'Token-first foundation',
        s3_b2:        'Component library with every state',
        s3_b3:        'Documentation and governance rules',
        s3_b4:        'Walkthrough videos in English and Arabic, plus live training',
        s3_meta:      'Three to six months',
        s3_price:     'Scoped per project',
        s3_note:      'Last one shipped: 1,033 variables, 24 components, three languages.',
      ...
      footer: {
        ...
        form_hint:           'What are you building, and what is in the way?',
        form_reply:          'I read every message myself and usually reply within a day.',
        form_err_name:       'Please add your name.',
        form_err_email:      'Please add your email.',
        form_err_email_bad:  'That email address does not look right.',
      ...
      cs: {
        ...
        a11y: { eyebrow: "Accessibility", title: "WCAG 2.1 AA, built into the foundation", lead: "Accessibility was one of the areas I owned. I didn't just document WCAG 2.1 AA, I turned it into tokens, reusable Figma checks (a contrast matrix and a 44×44 touch-target component).", i1_t: "Contrast as a contract", i1_p: "4.5:1 for text, 3:1 for large text and UI, checked against the standard in both light and dark, with unsafe combinations corrected at the token level.", i2_t: "Never colour alone", i2_p: "ERP statuses always pair colour with an icon and a text label, so meaning survives colour-blindness and greyscale.", i3_t: "Touch & focus tokens", i3_p: "A 44×44 pt minimum touch target and a 2 px offset focus ring are tokenised. Keyboard and mobile users are covered by default.", i4_t: "Trilingual reading order", i4_p: "Every component specifies dynamic <code>lang</code>/<code>dir</code>, a logical reading order, and localised labels. That structure is what assistive technology reads from, and it lives in the system rather than in each product.", i5_t: "Built to be tested", i5_p: "The tokens and reusable Figma checks mean a full verification pass is fast to set up once the system ships into a live product. That pass hasn't happened yet on Iksir specifically. What's true today is that accessibility is built into the foundation, not bolted on after.", i6_t: "Dual-script sizing", i6_p: "Arabic body text is bumped 1–2 px above the Latin baseline, with line-height tokens tuned so complex ligatures never clip in dense data tables." },
      ...
      cs2: {
        ...
        stats: { faster: "faster inventory task execution in usability tests", workflows: "operational workflows unified", screens: "screens designed", breakpoints: "breakpoints: mobile, tablet, desktop", components: "components in the supporting library", iterations: "major product iterations" },
        ...
        process: { eyebrow: "The process", title: "From the shop floor to the screen", lead: "The work moved in loops, not a line, but each pass had a centre of gravity: understand the operation, model it, then iterate it against reality.", p1_label: "Phase", p1_title: "Understand the operation", p1_body: "With the business analyst I ran visualization sessions that turned functional documents into task flows, wireframes, and data hierarchies, starting on paper. Before any UI, I needed to know what a worker actually holds, scans, counts, and confirms in each operation.", p1_call: "<b>My call →</b> design for the worker's context first (standing, one-handed, on a shared device, interrupted constantly), and let every layout decision follow from that.", p2_label: "Phase", p2_title: "One task model for six workflows", p2_body: "Purchasing, inventory, shelf labelling, stock correction, sales-floor replenishment, and ad-hoc tasks all behave differently on paper. I structured every one of them into the same three layers, a task list with filters, a task detail with its people and data, and an execution view with direct in-task actions. Learn the app once, and every operation feels familiar.", p2_call: "<b>The decision that mattered →</b> one model, not six mini-apps. It's what made the app scalable to new modules and instantly learnable for new staff.", p3_label: "Phase", p3_title: "Iterate against reality", p3_body: "Screens went to the developers and to usability tests with real supermarket users, and their feedback came straight back into Figma, clearer specs, tighter spacing, better data rendering. The redesign measured 50% faster inventory task execution than the old flows, and shared testing sessions kept design and engineering honest with each other.", p3_call: "<b>The principle I held →</b> a spec is a conversation, not a handoff. Short direct loops with four developers beat any formal process we could have run.", loop: "<b>The loop in action:</b> after release, field reality pushed us further: floor workers wanted to drive whole operations from the barcode scanner. That became a dedicated scan-first variant of the task flows, 47 screens designed around the scanner as the primary input, not the keyboard.", lofi_label: "Where it started: paper and lo-fi", cap_lofi1: "<b>Paper first</b>: sketching the task screens before touching Figma.", cap_lofi2: "<b>Data hierarchy</b>: deciding what a worker reads first, second, and never.", cap_lofi3: "<b>Lo-fi wireframes</b>: structure and flow validated in grayscale before any styling." },
        ...
        impact: { eyebrow: "Results & impact", title: "What it changed", lead: "The redesign was validated where it counts (with real supermarket users doing real operations), and in the day-to-day speed of the team building it.", i1_t: "50% faster inventory task execution", i1_p: "In usability tests with real supermarket users, the redesigned flows cut inventory task time roughly in half, clearer hierarchy, fewer steps, and no tool-switching mid-task.", i2_t: "Fewer errors where they hurt", i2_p: "Stock corrections and order tracking (the two places where a mistake costs real money) saw reduced error rates once the flows guided the work step by step.", i3_t: "Developers shipped faster", i3_p: "Reusable components and dev-ready specs cut rework and kept implementation faithful to the design, the developers' own words, not mine.", i4_t: "The benchmark for the suite", i4_p: "Task Master became the reference for how Datamaster's future ERP modules should look, feel, and be built, the app that proved the foundation." },
    ...
    fr: {
      meta: {
        home: {
          ...
          desc:  "Designer produit pour ERP, SaaS et outils internes. Workflows denses en données, design systems orientés tokens. 1 033 variables, 24 composants, trois langues.",
        ...
        cs1: {
          ...
          og:    'Comment j\'ai piloté la stratégie, les fondations, l\'accessibilité et la couche mobile d\'un design system trilingue orienté tokens.'
        },
        cs2: {
          ...
          og:    'Comment j\'ai transformé des opérations pilotées par tableurs en un modèle de tâches lisible. 50% d\'exécution plus rapide des tâches d\'inventaire en tests d\'utilisabilité.'
        },
        cs3: {
      ...
      work: {
        ...
        open_aria:     'Ouvrir l\'étude de cas',
        open_label:    'Ouvrir',
        ...
        cs2: {
          ...
          outcome:      '50 % d\'exécution des tâches d\'inventaire plus rapide, moins d\'erreurs de correction de stock, et la référence visuelle de la suite ERP de Datamaster.',
          stat1_num: '50', stat1_suffix: '%', stat1_label: "exécution des tâches d'inventaire plus rapide",
        ...
        cs3: {
          ...
          outcome:      'Une hiérarchie de données claire sur tout le parcours devis-à-retour, et la base de mise en page pour 3 autres modules ERP.',
      ...
      experience: {
        ...
        nawat: {
          ...
          duration:  '7 mois',
          hint:      '4 points clés',
          desc_0:    '- Datamaster Analytics, mon partenaire design produit depuis septembre 2024 (ci-dessous), est le premier client de Nawat Studio : en février 2026, le partenariat s\'est élargi au projet Iksir Design System.',
        ...
        dma: {
          ...
          duration:  '2 ans',
          hint:      '2 rôles · 8 points',
          role_a:    'Partenaire Design Produit',
          ...
          desc_a1:   '- Travail sur cinq modules ERP principaux : Ventes B2B, Achats, PDV, Finance et Comptabilité, chacun gérant des données denses sur des workflows multi-rôles complexes',
          ...
          desc_a5:   '- En février 2026, ce partenariat s\'est élargi au projet Iksir Design System, réalisé sous Nawat Studio avec un second designer dans l\'équipe, tandis que le travail direct sur les modules ERP se poursuit. La seconde itération de Task Master a ensuite été reconstruite sur ce système',
          ...
          desc_b1:   '- Conception d\'une application de gestion des tâches mobile-first pour les équipes de magasin : la première itération, mise en production'
        },
        five: {
          company:   'Five Angles',
          role:      'Designer UI/UX',
      ...
      services: {
        ...
        subtitle:     'Commencez par une lecture de ce que vous avez déjà, ou allez droit au système en dessous.',
        chip:         'Commencez ici',
        s1_title:     'Audit Produit',
        s1_promise:   'Une lecture complète de votre produit, rédigée et priorisée.',
        s1_b1:        "Heuristiques, architecture de l'information, hiérarchie",
        s1_b2:        "Accessibilité au regard du WCAG 2.1 AA",
        s1_b3:        "Préparation à l'arabe et au sens droite-à-gauche",
        s1_b4:        'Rapport, liste classée, feuille de route, appel',
        s1_meta:      'Environ une semaine',
        s1_price:     'À partir de 1 300 $',
        s1_note:      "Les tests avec lecteur d'écran ne sont pas inclus. Je vous orienterai vers quelqu'un qui les fait.",
        s1_cta:       'Réserver un audit',
        s2_title:     'Design Produit',
        s2_promise:   'Un module, un parcours, un tableau de bord ou une application, prêt à être développé.',
        s2_b1:        'Parcours utilisateur et wireframes',
        s2_b2:        'Écrans finaux avec tous les états',
        s2_b3:        'Un prototype fonctionnel',
        s2_b4:        'Passation aux développeurs et une session avec les ingénieurs',
        s2_meta:      'Six à dix semaines par module',
        s2_price:     'Cadré par projet',
        s2_note:      'Facturé par module ou par parcours, jamais pour le produit entier.',
        s2_cta:       'Cadrons-le ensemble',
        s3_title:     'Design System',
        s3_promise:   'La fondation sur laquelle vos produits sont construits.',
        s3_b1:        'Fondation orientée tokens',
        s3_b2:        'Bibliothèque de composants avec tous les états',
        s3_b3:        'Documentation et règles de gouvernance',
        s3_b4:        'Vidéos de prise en main en anglais et en arabe, plus une formation en direct',
        s3_meta:      'Trois à six mois',
        s3_price:     'Cadré par projet',
        s3_note:      'Le dernier livré : 1 033 variables, 24 composants, trois langues.',
      ...
      footer: {
        ...
        form_email:       'Email',
        form_message:     'Message',
        form_hint:           'Que construisez-vous, et quel est le blocage ?',
        form_reply:          'Je lis chaque message moi-même et je réponds en général sous un jour.',
        form_err_name:       'Merci d’indiquer votre nom.',
        form_err_email:      'Merci d’indiquer votre email.',
        form_err_email_bad:  'Cette adresse email ne semble pas valide.',
        form_err_message:    'Merci d’écrire un court message.',
      ...
      cs: {
        ...
        a11y: { eyebrow: "Accessibilité", title: "WCAG 2.1 AA, intégrée à la base", lead: "L'accessibilité faisait partie des domaines que je pilotais. Je n'ai pas seulement documenté le WCAG 2.1 AA, je l'ai transformé en tokens, en vérifications Figma réutilisables (une matrice de contraste et un composant de zone tactile 44×44).", i1_t: "Le contraste comme contrat", i1_p: "4,5:1 pour le texte, 3:1 pour le grand texte et l'UI, contrôlés au regard de la norme en clair comme en sombre, les combinaisons risquées étant corrigées au niveau des tokens.", i2_t: "Jamais la couleur seule", i2_p: "Les statuts ERP associent toujours la couleur à une icône et à un libellé, pour que le sens survive au daltonisme et aux niveaux de gris.", i3_t: "Tokens de zone tactile et de focus", i3_p: "Une zone tactile minimale de 44×44 pt et un anneau de focus décalé de 2 px sont en tokens. Les utilisateurs au clavier et sur mobile sont couverts par défaut.", i4_t: "Ordre de lecture trilingue", i4_p: "Chaque composant précise des attributs <code>lang</code>/<code>dir</code> dynamiques, un ordre de lecture logique et des libellés localisés. C'est cette structure que lisent les technologies d'assistance, et elle vit dans le système plutôt que dans chaque produit.", i5_t: "Conçue pour être testée", i5_p: "Les tokens et les vérifications Figma réutilisables permettent de mettre en place rapidement une passe de vérification complète une fois le système intégré à un produit en production. Cette passe n'a pas encore eu lieu sur Iksir spécifiquement. Ce qui est vrai aujourd'hui, c'est que l'accessibilité est intégrée à la base, pas ajoutée après coup.", i6_t: "Dimensionnement bi-script", i6_p: "Le texte courant arabe est augmenté de 1 à 2 px par rapport à la ligne de base latine, avec des tokens de hauteur de ligne ajustés pour que les ligatures complexes ne soient jamais coupées dans les tableaux de données denses." },
      ...
      cs2: {
        ...
        stats: { faster: "exécution des tâches d'inventaire plus rapide en tests d'utilisabilité", workflows: "workflows opérationnels unifiés", screens: "écrans conçus", breakpoints: "breakpoints : mobile, tablette, desktop", components: "composants dans la bibliothèque associée", iterations: "itérations majeures du produit" },
    ...
    ar: {
      meta: {
        ...
        cs2: {
          ...
          og:    'كيف حوّلتُ عمليات المتاجر المُدارة بجداول البيانات إلى نموذج مهام واضح. تنفيذ أسرع لمهام الجرد بنسبة 50% في اختبارات قابلية الاستخدام.'
        },
        cs3: {
      ...
      work: {
        ...
        cs2: {
          ...
          outcome:      'تنفيذ أسرع لمهام الجرد بنسبة 50%، أخطاء أقل في تصحيح المخزون، والمرجع البصري لمنظومة ERP لدى Datamaster.',
          stat1_num: '50', stat1_suffix: '%', stat1_label: 'تنفيذ أسرع لمهام الجرد',
        ...
        cs3: {
          ...
          outcome:      'تسلسل واضح للبيانات عبر مسار كامل من عرض السعر إلى الإرجاع، وأساس التصميم لثلاث وحدات ERP إضافية.',
        ...
        cs5: {
          ...
          tag1: 'أنظمة التصميم', tag2: 'إمكانية الوصول', tag3: 'Design Tokens'
        }
      },
      proof: {
      ...
      experience: {
        ...
        nawat: {
          ...
          duration:  '7 أشهر',
          hint:      '4 نقاط بارزة',
          desc_0:    '- شركة Datamaster Analytics، شريكي في تصميم المنتج منذ سبتمبر 2024 (أدناه)، هي أول عميل لاستوديو نواة: ففي فبراير 2026 توسّعت الشراكة لتشمل مشروع Iksir Design System.',
        ...
        dma: {
          ...
          desc_a1:   '- العمل على خمس وحدات ERP أساسية: المبيعات B2B، والمشتريات، ونقاط البيع، والمالية، والمحاسبة، كل منها يتعامل مع كثافة بيانات عالية عبر مسارات عمل معقدة متعددة الأدوار',
          ...
          desc_a5:   '- في فبراير 2026، توسّعت هذه الشراكة لتشمل مشروع Iksir Design System، المُنجَز عبر استوديو نواة بانضمام مصمم ثانٍ إلى الفريق، بينما يستمر العمل المباشر على وحدات ERP. أُعيد لاحقًا بناء الإصدار الثاني من Task Master اعتمادًا على هذا النظام',
          role_b:    'مصمم UI/UX',
          dates_b:   'سبتمبر 2024 - نوفمبر 2024',
          desc_b0:   'مهمة فريلانس أولية مركّزة على المنتج الجوّال للشركة.',
          desc_b1:   '- تصميم تطبيق إدارة مهام بأولوية للجوّال لفرق متاجر التجزئة: الإصدار الأول، الذي وُضع في الإنتاج'
        },
        five: {
          company:   'Five Angles',
          role:      'مصمم UI/UX',
      ...
      services: {
        ...
        subtitle:     'ابدأ بقراءة ما لديك الآن، أو اذهب مباشرة إلى النظام الذي تقوم عليه المنتجات.',
        chip:         'ابدأ من هنا',
        s1_title:     'تدقيق المنتج',
        s1_promise:   'قراءة كاملة لمنتجك، مكتوبة ومرتّبة حسب الأولوية.',
        s1_b1:        'مراجعة إرشادية، ومعمارية المعلومات، والتسلسل',
        s1_b2:        'إمكانية الوصول وفق WCAG 2.1 AA',
        s1_b3:        'جاهزية العربية والاتجاه من اليمين إلى اليسار',
        s1_b4:        'تقرير، وقائمة مشكلات مرتّبة، وخارطة طريق، ومكالمة',
        s1_meta:      'نحو أسبوع',
        s1_price:     'من 1,300 دولار',
        s1_note:      'اختبار قارئات الشاشة غير مشمول. سأحيلك إلى من يتقنه.',
        s1_cta:       'احجز تدقيقًا',
        s2_title:     'تصميم المنتج',
        s2_promise:   'وحدة أو مسار عمل أو لوحة معلومات أو تطبيق، جاهز للتطوير.',
        s2_b1:        'مسارات المستخدم والـwireframes',
        s2_b2:        'شاشات نهائية بكل حالاتها',
        s2_b3:        'نموذج تفاعلي',
        s2_b4:        'تسليم للمطوّرين وجلسة مع المهندسين',
        s2_meta:      'ستة أسابيع إلى عشرة لكل وحدة',
        s2_price:     'يُحدَّد حسب المشروع',
        s2_note:      'يُسعّر لكل وحدة أو لكل مسار، لا للمنتج كاملًا.',
        s2_cta:       'لنحدّد النطاق',
        s3_title:     'نظام التصميم',
        s3_promise:   'الأساس الذي تُبنى عليه منتجاتك.',
        s3_b1:        'أساس قائم على الـtokens',
        s3_b2:        'مكتبة مكوّنات بكل الحالات',
        s3_b3:        'توثيق وقواعد حَوكمة',
        s3_b4:        'فيديوهات شرح بالعربية والإنجليزية، وتدريب مباشر',
        s3_meta:      'ثلاثة إلى ستة أشهر',
        s3_price:     'يُحدَّد حسب المشروع',
        s3_note:      'آخر نظام سُلّم: 1,033 متغيّرًا، و24 مكوّنًا، وثلاث لغات.',
      ...
      footer: {
        ...
        form_hint:           'ما الذي تبنيه، وأين العائق؟',
        form_reply:          'أقرأ كل رسالة بنفسي، وأردّ عادةً خلال يوم.',
        form_err_name:       'من فضلك اكتب اسمك.',
        form_err_email:      'من فضلك اكتب بريدك الإلكتروني.',
        form_err_email_bad:  'هذا البريد الإلكتروني لا يبدو صحيحًا.',
        form_err_message:    'من فضلك اكتب رسالة قصيرة.',
      ...
      cs: {
        ...
        a11y: { eyebrow: "إمكانية الوصول", title: "WCAG 2.1 AA، مدمجة في الأساس", lead: "كانت إمكانية الوصول من المجالات التي أتولّاها. لم أكتفِ بتوثيق WCAG 2.1 AA، بل حوّلتُه إلى tokens، وإلى فحوص قابلة لإعادة الاستخدام في Figma (مصفوفة تباين ومكوّن هدف لمسي 44×44).", i1_t: "التباين كعقد", i1_p: "4.5:1 للنص، و3:1 للنص الكبير وعناصر الواجهة، مقيسة وفق المعيار في الوضعين الفاتح والداكن، مع تصحيح التركيبات غير الآمنة على مستوى الـtokens.", i2_t: "لا اعتماد على اللون وحده", i2_p: "تقرن حالات ERP اللونَ دائمًا بأيقونة ونص، لكي يبقى المعنى قائمًا مع عمى الألوان والتدرّج الرمادي.", i3_t: "tokens للهدف اللمسي والتركيز", i3_p: "هدف لمسي أدنى 44×44 pt وحلقة تركيز مُزاحة 2 px، كلاهما في tokens. مستخدمو لوحة المفاتيح والجوال مشمولون افتراضيًا.", i4_t: "ترتيب القراءة ثلاثي اللغة", i4_p: "يحدّد كل مكوّن سمتَي <code>lang</code>/<code>dir</code> ديناميكيتين، وترتيب قراءة منطقيًا، وتسميات مُترجَمة. هذه البنية هي ما تقرأ منه التقنيات المساعِدة، وهي مكتوبة داخل النظام لا متروكة لكل منتج.", i5_t: "بُنيت لتكون قابلة للاختبار", i5_p: "الـtokens والفحوص القابلة لإعادة الاستخدام في Figma تجعل إجراء تحقّق شامل أمرًا سريع الإعداد بمجرد أن يُدمَج النظام في منتج حيّ. هذا التحقّق لم يحدث بعد على Iksir تحديدًا. والحقيقي اليوم هو أن إمكانية الوصول مبنية في الأساس، لا مُضافة لاحقًا.", i6_t: "أحجام النصّين", i6_p: "يُزاد نص المتن العربي بمقدار 1–2 px عن خط الأساس اللاتيني، مع ضبط tokens ارتفاع السطر بحيث لا تُقتَص الروابط المعقّدة أبدًا في الجداول الكثيفة." },
      ...
      cs2: {
        ...
        stats: { faster: "تنفيذ أسرع لمهام الجرد في اختبارات قابلية الاستخدام", workflows: "مسارات عمل تشغيلية موحّدة", screens: "شاشة مصمّمة", breakpoints: "breakpoints: جوال، لوحي، سطح مكتب", components: "مكوّنًا في المكتبة الداعمة", iterations: "إصداران رئيسيان للمنتج" },
  ...
  function applyFavicon(lang) {
    ...
    if (!favicon) return;
    // The href is authored per page: 'assets/icons/...' on the homepage and
    // '../assets/icons/...' on the three case studies. This used to hard-code
    // the root-relative form, so a language switch on a case-study page asked
    // for case-studies/assets/icons/... and the tab icon silently disappeared.
    // Derive the prefix from whatever the page already points at instead.
    // getAttribute, not .href, so we read the authored relative value.
    const current = favicon.getAttribute('href') || '';
    const match   = current.match(/^(.*?)favicon(?:-ar)?\.svg$/);
    const base    = match ? match[1] : 'assets/icons/';
    favicon.setAttribute('href', base + (RTL_LANGS.includes(lang)
      ? 'favicon-ar.svg'
      : 'favicon.svg'));
  }
