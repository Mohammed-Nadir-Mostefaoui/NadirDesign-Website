    ...
    en: {
      ...
      work: {
        ...
        cs5: {
          ...
          outcome:      'Shipped V1: 1,033 variables, 24 components, and a live documentation platform used across web and mobile.',
      ...
      cs: {
        ...
        lib: { eyebrow: "The library", title: "24 components — every state, documented", lead: "From primitives like Button (450 variants spanning hierarchy, size, icon position, and state) to mobile-native pieces I designed for the task app. Every variant is real — none are hypothetical.", core_label: "Core components", cap_button: "<b>Button</b> — 450 variants", cap_input: "<b>Input</b> — 336 variants", cap_card: "<b>Card</b> — 12 variants", cap_modal: "<b>Modal</b> — icon × size", mobile_label: "Mobile-native — the layer I designed", cap_task: "<b>Task Card</b> — 17 variants across priority, status, and subtasks", cap_tabnav: "<b>Bottom Tab Nav</b> — active pill + badges", cap_sheet: "<b>Bottom Sheet</b> — collapsed / half / full", patterns_label: "Patterns", cap_charts: "<b>Charts</b> — line, bar, donut, area, sparkline; mobile-first", cap_charttokens: "<b>Chart tokens</b> — palette drawn from primitives + usage rules", note: "<b>A note on what's shown:</b> Iksir is live client work under NDA, so I'm showing the design system itself — the tokens, components, and patterns — rather than the client's production screens or any real data. What you see here is the reusable library, which is safe to share; the products it powers stay private." },
        ...
        status: { eyebrow: "Where it stands", title: "Shipped, and still evolving", s1_label: "Done", s1_t: "V1 released", s1_p: "Foundations, 24 components, 5 patterns, and the documentation platform — all live as the official V1.", s2_label: "Live & iterating", s2_t: "Adoption & polish", s2_p: "The library is in use and improving. My partner led a polished public version of the site on top of the shared V1.", s3_label: "In progress", s3_t: "Integration strategy", s3_p: "I'm defining how the system rolls into the real products, and keeping governance open until it's fully stable." },
    ...
    fr: {
      ...
      work: {
        ...
        cs5: {
          ...
          outcome:      'Livraison de la V1 : 1 033 variables, 24 composants et une plateforme de documentation en ligne utilisée sur le web et le mobile.',
      ...
      cs: {
        ...
        lib: { eyebrow: "La bibliothèque", title: "24 composants — chaque état, documenté", lead: "Des primitives comme le bouton (450 variantes couvrant hiérarchie, taille, position d'icône et état) jusqu'aux pièces natives mobiles que j'ai conçues pour l'application de tâches. Chaque variante est réelle — aucune n'est hypothétique.", core_label: "Composants principaux", cap_button: "<b>Bouton</b> — 450 variantes", cap_input: "<b>Champ de saisie</b> — 336 variantes", cap_card: "<b>Carte</b> — 12 variantes", cap_modal: "<b>Fenêtre modale</b> — icône × taille", mobile_label: "Natifs mobiles — la couche que j'ai conçue", cap_task: "<b>Carte de tâche</b> — 17 variantes selon priorité, statut et sous-tâches", cap_tabnav: "<b>Barre d'onglets</b> — pastille active + badges", cap_sheet: "<b>Bottom sheet</b> — repliée / à mi-hauteur / plein écran", patterns_label: "Modèles", cap_charts: "<b>Graphiques</b> — courbe, barres, donut, aire, sparkline ; pensés mobile d'abord", cap_charttokens: "<b>Tokens de graphiques</b> — palette issue des primitives + règles d'usage", note: "<b>Une note sur ce qui est montré :</b> Iksir est un travail client en cours sous NDA ; je montre donc le design system lui-même — les tokens, composants et modèles — plutôt que les écrans de production du client ou de véritables données. Ce que vous voyez ici, c'est la bibliothèque réutilisable, que je peux partager ; les produits qu'elle alimente restent privés." },
    ...
    ar: {
      ...
      work: {
        ...
        cs5: {
          ...
          outcome:      'إطلاق النسخة الأولى: 1,033 متغيّرًا، و24 مكوّنًا، ومنصة توثيق حيّة تُستخدم عبر الويب والموبايل.',
      ...
      cs: {
        ...
        lib: { eyebrow: "المكتبة", title: "24 مكوّنًا — كل حالة موثّقة", lead: "من الأساسيات مثل الزر (450 نسخة تشمل التسلسل والحجم وموضع الأيقونة والحالة) إلى القطع المخصّصة للموبايل التي صمّمتُها لتطبيق المهام. كل نسخة حقيقية — لا شيء افتراضي.", core_label: "المكوّنات الأساسية", cap_button: "<b>الزر</b> — 450 نسخة", cap_input: "<b>حقل الإدخال</b> — 336 نسخة", cap_card: "<b>البطاقة</b> — 12 نسخة", cap_modal: "<b>النافذة المنبثقة</b> — أيقونة × حجم", mobile_label: "المخصّصة للموبايل — الطبقة التي صمّمتُها", cap_task: "<b>بطاقة المهمة</b> — 17 نسخة حسب الأولوية والحالة والمهام الفرعية", cap_tabnav: "<b>شريط التبويب السفلي</b> — مؤشّر نشط + شارات", cap_sheet: "<b>Bottom sheet</b> — مطوية / نصفية / كاملة", patterns_label: "الأنماط", cap_charts: "<b>الرسوم البيانية</b> — خطية، أعمدة، دونات، مساحية، sparkline؛ مصمّمة للموبايل أولًا", cap_charttokens: "<b>tokens الرسوم</b> — لوحة مشتقّة من الـprimitives + قواعد الاستخدام", note: "<b>ملاحظة حول ما يُعرَض:</b> Iksir عمل حيّ لعميل تحت اتفاقية سرية (NDA)، لذا أعرض نظام التصميم نفسه — الـtokens والمكوّنات والأنماط — لا شاشات الإنتاج لدى العميل أو أي بيانات حقيقية. ما ترونه هنا هو المكتبة القابلة لإعادة الاستخدام، وهي آمنة للمشاركة؛ أما المنتجات التي تشغّلها فتبقى خاصة." },
