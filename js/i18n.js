    ...
    en: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_b1:   '- Designed a mobile-first Task Management App for retail store teams, across 2 iterations over the project lifecycle'
        },
        five: {
          company:   'Five Angles',
          role:      'UI/UX Designer',
      ...
      services: {
        ...
        s2_meta:      'Two to four weeks per module',
    ...
    fr: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_b1:   '- Conception d\'une application de gestion des tâches mobile-first pour les équipes de magasin, sur 2 itérations tout au long du cycle de projet'
        },
        five: {
          company:   'Five Angles',
          role:      'Designer UI/UX',
      ...
      services: {
        ...
        s2_meta:      'Deux à quatre semaines par module',
    ...
    ar: {
      ...
      experience: {
        ...
        dma: {
          ...
          desc_b1:   '- تصميم تطبيق إدارة مهام بأولوية للجوّال لفرق متاجر التجزئة، عبر تكرارين على مدار دورة المشروع'
        },
        five: {
          company:   'Five Angles',
          role:      'مصمم UI/UX',
      ...
      services: {
        ...
        s2_meta:      'أسبوعان إلى أربعة لكل وحدة',
        ...
        s3_meta:      'ستة إلى اثني عشر أسبوعًا',
      ...
      cs3: {
        hero: { eyebrow: "دراسة حالة 03 · ERP لمبيعات B2B", title: "وحدة ERP لمبيعات B2B", sub: "القلب التجاري لمنظومة ERP، عروض الأسعار والطلبات والتجهيز والتسليم والإرجاع لعملاء الشركات، منظّمة في مساحة عمل واحدة مقروءة وكثيفة البيانات، بدل كومة من الأدوات المتفرّقة.", role_k: "الدور", role_v: "مصمم منتجات · UI/UX", client_k: "صاحب العمل", client_v: "Datamaster Analytics · ERP، فرنسا", team_k: "الفريق", team_v: "محلّل أعمال · قائد تقني · مطوّرو front & back-end", platform_k: "المنصة", platform_v: "ويب سطح المكتب · شاشات كثيفة البيانات", cta: "لنبدأ مشروعًا مثل هذا", status: "البنية معتمدة · جاهزة للصقل البصري" },
